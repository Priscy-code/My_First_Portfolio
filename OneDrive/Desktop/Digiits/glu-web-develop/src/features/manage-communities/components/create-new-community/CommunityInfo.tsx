...
const CommunityInfoForm = ({ onCreateCommunity }: { onCreateCommunity: (community: Partial<Community>) => void }) => {
    ...
    >
      {({ values, errors, touched, setFieldValue, handleSubmit, resetForm }) => (
        <Form onSubmit={handleSubmit} className="space-y-6">
          ...
          <FormInput label="Group Name" active={activeField === 'Group name'}>
            <Field
              type="text"
              id="groupName"
              name="name"
          ...
          <p className="text-xs text-gray-800 mt-1"><span className="text-red-500">*</span> Separate each tag with a comma "," - Maximum 5 tags</p>
